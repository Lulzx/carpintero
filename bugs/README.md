...
lexing each file twice, raw and stripped, and comparing the blocks —
and two files in Arturo's own test suite came back unequal with every
element rendering identically. The stripper was correct; equality was not.
